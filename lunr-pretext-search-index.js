...
{
  "id": "ssec-special-inverses-3",
  "level": "2",
  "url": "sec-precalc-funcs.html#ssec-special-inverses-3",
  "type": "Example",
  "number": "0.3.9",
  "title": "",
...
},
{
  ...
  "number": "0.6",
  "title": "Exponentials",
  "body": " Exponentials  Exponential functions play a central role in calculus. They arise in models of population growth, radioactive decay, compound interest, and many other applications. In this section, we review the algebraic properties of exponents and develop systematic methods for solving exponential equations.  The focus here is on algebraic techniques. Later in the course, these same ideas will be extended using logarithms and calculus.    Exponential Expressions  An exponential expression is one in which the variable appears in the exponent. For example, and are exponential expressions.   Exponential Function   An exponential function is a function of the form   where and .       Properties of Exponents  Solving exponential equations relies on the fundamental properties of exponents. These rules allow us to rewrite expressions in simpler or more useful forms.    Assume and are real numbers. Then the following properties hold:      These properties do not apply when adding or subtracting exponential terms. For example, .      Changing the Base and the Role of  In algebra, exponential expressions can be written using many different bases. In calculus, however, it is often convenient to rewrite exponentials using base . This is because derivatives and integrals involving have especially simple formulas.  The idea of changing the base allows us to rewrite any exponential expression in terms of a different base. Later, logarithms will give us a systematic way to do this.    Any exponential expression with and can be rewritten using base .  In particular, there exists a real number such that      The value of depends on the base . Later in the course, we will see that , where is the natural logarithm.     Rewrite using base .    There exists a constant such that   This constant is , so       Rewrite using base .    Using the change of base idea,      In calculus, derivatives and integrals of are much simpler than those of for other bases. For this reason, exponential models are often rewritten using base before applying calculus techniques.      Solving Exponential Equations with the Same Base  The simplest exponential equations are those in which both sides can be written using the same base. In this case, the exponents can be set equal.    If , , and   then .      Solve .    Rewrite both sides with base .   Set the exponents equal.       Solve .    Rewrite using base .   Set exponents equal.        Solving Exponential Equations by Rewriting  Sometimes an equation does not initially have matching bases. In these cases, we attempt to rewrite both sides using a common base.    Solve .    Rewrite as a power of .   Simplify and equate exponents.        When Exponential Equations Have No Solution  Exponential functions, , are always positive. This observation can be used to identify equations with no real solution.    Solve .    Since for all real , this equation has no real solution.     "
},
{
  ...
  "body": " Exponential Function   An exponential function is a function of the form   where and .   "
},
{
  "id": "pr-exp-laws",
  "level": "2",
  "url": "sec-precalc-exp.html#pr-exp-laws",
  "type": "Principle",
  "number": "0.6.2",
  "title": "",
  "body": "  Assume and are real numbers. Then the following properties hold:    "
},
{
  "id": "ssec-exp-properties-4",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-properties-4",
  "type": "Remark",
  "number": "0.6.3",
  "title": "",
  "body": " These properties do not apply when adding or subtracting exponential terms. For example, .  "
},
{
  "id": "pr-exp-change-base",
  "level": "2",
  "url": "sec-precalc-exp.html#pr-exp-change-base",
  "type": "Principle",
  "number": "0.6.4",
  "title": "",
  "body": "  Any exponential expression with and can be rewritten using base .  In particular, there exists a real number such that    "
},
{
  "id": "ssec-exp-change-base-5",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-change-base-5",
  "type": "Remark",
  "number": "0.6.5",
  "title": "",
  "body": " The value of depends on the base . Later in the course, we will see that , where is the natural logarithm.  "
},
{
  "id": "ssec-exp-change-base-6",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-change-base-6",
  "type": "Example",
  "number": "0.6.6",
  "title": "",
  "body": "  Rewrite using base .    There exists a constant such that   This constant is , so    "
},
{
  "id": "ssec-exp-change-base-7",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-change-base-7",
  "type": "Example",
  "number": "0.6.7",
  "title": "",
  "body": "  Rewrite using base .    Using the change of base idea,    "
},
{
  "id": "ssec-exp-change-base-8",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-change-base-8",
  "type": "Remark",
  "number": "0.6.8",
  "title": "",
  "body": " In calculus, derivatives and integrals of are much simpler than those of for other bases. For this reason, exponential models are often rewritten using base before applying calculus techniques.  "
},
{
  "id": "pr-exp-equal-bases",
  "level": "2",
  "url": "sec-precalc-exp.html#pr-exp-equal-bases",
  "type": "Principle",
  "number": "0.6.9",
  "title": "",
  "body": "  If , , and   then .   "
...
{
  "id": "ssec-exp-eq-same-base-4",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-eq-same-base-4",
  "type": "Example",
  "number": "0.6.10",
  "title": "",
  "body": "  Solve .    Rewrite both sides with base .   Set the exponents equal.    "
},
{
  "id": "ssec-exp-eq-same-base-5",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-eq-same-base-5",
  "type": "Example",
  "number": "0.6.11",
  "title": "",
  "body": "  Solve .    Rewrite using base .   Set exponents equal.    "
},
{
  "id": "ssec-exp-eq-rewrite-3",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-eq-rewrite-3",
  "type": "Example",
  "number": "0.6.12",
  "title": "",
  "body": "  Solve .    Rewrite as a power of .   Simplify and equate exponents.    "
},
{
  "id": "ssec-exp-no-solution-3",
  "level": "2",
  "url": "sec-precalc-exp.html#ssec-exp-no-solution-3",
  "type": "Example",
  "number": "0.6.13",
  "title": "",
  "body": "  Solve .    Since for all real , this equation has no real solution.   "
},
{
  "id": "sec-precalc-log",
  "level": "1",
  ...
  "number": "0.7",
  "title": "Logarithms",
  "body": " Logarithms  Text of section.  "
},
{
  "id": "sec-precalc-trig",
  "level": "1",
...
},
{
  ...
  "body": " Definition of the Derivative    Compute the derivative using the limit definition.  Interpret the derivative as an instantaneous rate of change and as the slope of a tangent line.  Rewrite the derivative definition using either or .  Define the derivative function and interpret it as a new function.  Recognize common situations where a derivative fails to exist (corners, cusps, vertical tangents, discontinuities).     Definition of the Derivative  In earlier sections, we saw that instantaneous velocity can be obtained as a limit of average velocities over shorter and shorter time increments. Likewise, the slope of a tangent line can be obtained as a limit of secant slopes as the secant point moves closer and closer to the point of tangency.  Both ideas measure an instantaneous rate of change. For a general function , we define its instantaneous rate of change at using the following limit.   Derivative at a Point   The derivative of a function at , denoted , is defined by   provided the limit exists.    Here is the change in the output, and is the change in the input. The quotient is the average rate of change over the interval from to , and the derivative is the limit as the increment shrinks to 0.  Another common form comes from substituting (so that ):   Geometrically, if exists, then it is the slope of the tangent line to at the point . The tangent line has equation    If the limit defining exists, we say is differentiable at . If the limit does not exist, then is undefined and is not differentiable at .     Computing Derivatives from the Definition  A derivative is always a limit of a difference quotient, so direct substitution usually produces the meaningless expression . The goal is to simplify the difference quotient until the limit can be evaluated.   A Rational Example   Find for .    Step by Step:      A Radical Example   Find for .    We multiply by the conjugate to eliminate the radical in the numerator.      A Cube Root Example   Find for .    Here we use the identity .   This example is a good preview of why we will soon develop derivative rules: computing derivatives from the limit definition can become algebraically heavy.      The Derivative Function  The derivative at a point is a single number. But we can compute the derivative for many input values, producing a new function.   Derivative Function   The derivative function of , denoted , is defined by   for all where this limit exists.     Computing a Derivative Function   Let . Find .    Step by Step:       When the Derivative Fails to Exist  Even if a function is defined at a point, the derivative may fail to exist there. Graphically, this happens when the curve does not have a single well-defined tangent line.  Common ways differentiability can fail include:   Corner: the left-hand and right-hand slopes are finite but different.  Cusp: the left-hand and right-hand slopes become infinite with opposite signs.  Vertical tangent: slopes become infinite (unbounded) with the same sign.  Discontinuity: if a function is not continuous at a point, then it cannot be differentiable there.    One-Sided Derivatives Agree   Let   Show that exists and find its value.    We compute the right-hand and left-hand derivatives.    Since the one-sided derivatives agree, .     A Corner   Consider . Explain why does not exist.    For , , so the slope near 0 from the right is 1. For , , so the slope near 0 from the left is . The left-hand and right-hand derivatives are not equal, so the derivative at 0 does not exist. Graphically, the curve has a corner at the origin.     A Vertical Tangent   Consider . Explain why the derivative at fails to exist as a finite number.    From the derivative function computed earlier, . As , the denominator approaches 0, so the slopes become unbounded. Graphically, the curve has a vertical tangent at the origin, so there is no finite tangent slope at .     A Discontinuity   Suppose has a jump discontinuity at . Explain why cannot exist.    If existed, then would be differentiable at , and differentiability forces continuity. But a jump discontinuity means is not continuous at . Therefore cannot exist.      Differentiability Implies Continuity   Differentiability Implies Continuity   If is differentiable at , then is continuous at .     The contrapositive is often the useful version in practice: if is not continuous at , then is not differentiable at .     Practice \/ Study Problems    Some True\/False Problems   Determine whether each statement is true or false and explain your reasoning.    If is differentiable at , then is continuous at .  True. Differentiability implies continuity.    If is continuous at , then is differentiable at .  False. A corner (like at 0) is continuous but not differentiable.    The derivative is the limit of slopes of secant lines through .  True. That is exactly what the difference quotient represents.    If , then must be a local maximum or minimum.  False. Horizontal tangent does not guarantee an extremum.    If the left-hand derivative and right-hand derivative at are equal, then exists.  True. Agreement of the one-sided derivative limits gives the two-sided derivative limit.    If a graph has a corner at , then does not exist.  True. The one-sided slopes are different.    A vertical tangent at means .  False. A vertical tangent corresponds to unbounded slope, not zero slope.    If is discontinuous at , then does not exist.  True. Discontinuity prevents differentiability.    The derivative function is defined for every where is defined.  False. A function can be defined but not differentiable at some points.    If for all in an interval, then is increasing on that interval.  True. Positive derivative corresponds to increasing behavior.    For (a constant function), we have for every .  True. The output does not change as the input changes.    If two functions have the same derivative on an interval, then they differ by a constant on that interval.  True. This idea will be justified more formally later, but it matches the meaning of “same rate of change.”      "
},
{
  ...
  "number": "2.2",
  "title": "",
  "body": "  Compute the derivative using the limit definition.  Interpret the derivative as an instantaneous rate of change and as the slope of a tangent line.  Rewrite the derivative definition using either or .  Define the derivative function and interpret it as a new function.  Recognize common situations where a derivative fails to exist (corners, cusps, vertical tangents, discontinuities).   "
},
{
...
},
{
  ...
  "body": " A Cube Root Example   Find for .    Here we use the identity .   This example is a good preview of why we will soon develop derivative rules: computing derivatives from the limit definition can become algebraically heavy.   "
},
{
...
},
{
  ...
  "body": " Computing a Derivative Function   Let . Find .    Step by Step:    "
},
{
  "id": "ex-left-right-derivative-exists",
  "level": "2",
  "url": "sec-derivative-defn.html#ex-left-right-derivative-exists",
  "type": "Example",
  "number": "2.2.8",
  "title": "One-Sided Derivatives Agree.",
  "body": " One-Sided Derivatives Agree   Let   Show that exists and find its value.    We compute the right-hand and left-hand derivatives.    Since the one-sided derivatives agree, .   "
},
{
  "id": "ex-corner-abs",
  "level": "2",
  "url": "sec-derivative-defn.html#ex-corner-abs",
  "type": "Example",
  "number": "2.2.9",
  "title": "A Corner.",
  "body": " A Corner   Consider . Explain why does not exist.    For , , so the slope near 0 from the right is 1. For , , so the slope near 0 from the left is . The left-hand and right-hand derivatives are not equal, so the derivative at 0 does not exist. Graphically, the curve has a corner at the origin.   "
},
{
  "id": "ex-vertical-tangent-cuberoot",
  "level": "2",
  "url": "sec-derivative-defn.html#ex-vertical-tangent-cuberoot",
  "type": "Example",
  "number": "2.2.10",
  "title": "A Vertical Tangent.",
  "body": " A Vertical Tangent   Consider . Explain why the derivative at fails to exist as a finite number.    From the derivative function computed earlier, . As , the denominator approaches 0, so the slopes become unbounded. Graphically, the curve has a vertical tangent at the origin, so there is no finite tangent slope at .   "
},
{
  "id": "ex-discontinuous-not-differentiable",
  "level": "2",
  "url": "sec-derivative-defn.html#ex-discontinuous-not-differentiable",
  "type": "Example",
  "number": "2.2.11",
  "title": "A Discontinuity.",
  "body": " A Discontinuity   Suppose has a jump discontinuity at . Explain why cannot exist.    If existed, then would be differentiable at , and differentiability forces continuity. But a jump discontinuity means is not continuous at . Therefore cannot exist.   "
},
{
...
},
{
  "id": "tf-deriv-01",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-01",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": " If is differentiable at , then is continuous at .  True. Differentiability implies continuity.  "
},
{
  "id": "tf-deriv-02",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-02",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": " If is continuous at , then is differentiable at .  False. A corner (like at 0) is continuous but not differentiable.  "
},
{
  "id": "tf-deriv-03",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-03",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": " The derivative is the limit of slopes of secant lines through .  True. That is exactly what the difference quotient represents.  "
},
{
  "id": "tf-deriv-04",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-04",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": " If , then must be a local maximum or minimum.  False. Horizontal tangent does not guarantee an extremum.  "
},
{
  "id": "tf-deriv-05",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-05",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": " If the left-hand derivative and right-hand derivative at are equal, then exists.  True. Agreement of the one-sided derivative limits gives the two-sided derivative limit.  "
},
{
  "id": "tf-deriv-06",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-06",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": " If a graph has a corner at , then does not exist.  True. The one-sided slopes are different.  "
},
{
  "id": "tf-deriv-07",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-07",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": " A vertical tangent at means .  False. A vertical tangent corresponds to unbounded slope, not zero slope.  "
},
{
  "id": "tf-deriv-08",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-08",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": " If is discontinuous at , then does not exist.  True. Discontinuity prevents differentiability.  "
},
{
  "id": "tf-deriv-09",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-09",
  "type": "Exercise",
  "number": "9",
  "title": "",
  "body": " The derivative function is defined for every where is defined.  False. A function can be defined but not differentiable at some points.  "
},
{
  "id": "tf-deriv-10",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-10",
  "type": "Exercise",
  "number": "10",
  "title": "",
  "body": " If for all in an interval, then is increasing on that interval.  True. Positive derivative corresponds to increasing behavior.  "
},
{
  "id": "tf-deriv-11",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-11",
  "type": "Exercise",
  "number": "11",
  "title": "",
  "body": " For (a constant function), we have for every .  True. The output does not change as the input changes.  "
},
{
  "id": "tf-deriv-12",
  "level": "2",
  "url": "sec-derivative-defn.html#tf-deriv-12",
  "type": "Exercise",
  "number": "12",
  "title": "",
  "body": " If two functions have the same derivative on an interval, then they differ by a constant on that interval.  True. This idea will be justified more formally later, but it matches the meaning of “same rate of change.”  "
},
{
...
},
{
  ...
  "body": " Trigonometric Derivatives    Use geometric and graphical reasoning to understand why and .  Use these results with the product and quotient rules to differentiate the remaining trigonometric functions.  Evaluate basic trigonometric limits by rewriting them in terms of .  Remember that standard trigonometric derivative formulas assume angles are measured in radians.     Derivative of Sine and Cosine  Sine and cosine are fundamental for describing periodic motion. One way to predict their derivatives is to look at graphs. If we estimate the slope of the graph at many points, we can sketch its derivative function. The slopes appear to match the graph of .   The graph of and the graph of its derivative (which matches ).      For all real (measured in radians), and .    A classical geometric argument uses the unit circle. The key idea is that when an angle increases by a very small amount, the corresponding change in is well-approximated by the opposite side of a tiny triangle whose hypotenuse is the arc length. Because radian measure equals arc length on the unit circle, this connects a difference quotient for sine to the cosine function.   A unit-circle picture motivating via a small angle increment.    In symbols, the derivative definition gives   A similar geometric argument (or the identity ) shows .    The following limits are immediate consequences of the sine and cosine derivative formulas:        For the first limit, use the derivative of sine at zero:   The second follows similarly from .      General Trigonometric Derivatives  Once we know and , we can differentiate the remaining trigonometric functions by rewriting them using sine and cosine together with the product and quotient rules.    Compute .    Use and apply the Quotient Rule.     The table below summarizes the standard derivatives of the six basic trigonometric functions.   Derivatives of the six basic trigonometric functions (angles in radians).                        These derivative formulas are valid when is measured in radians , not degrees.     Limits of Trigonometric Quotients  Many trigonometric limits can be evaluated by rewriting the expression until a factor of the form appears, where . Then we use .    Compute .    Multiply and divide by to create .   In the third line we used the substitution , so forces .      Compute .    Rewrite and then introduce the standard sine-over-input factors.   We used and also by the substitution .      Practice Problems    Differentiate .      Differentiate .      Differentiate .      Evaluate .      Evaluate by rewriting it using a known limit or a derivative interpretation.     "
},
{
...
{
  "id": "fig-sin-cos-derivative-graph",
  "level": "2",
  "url": "sec-derivative-trig.html#fig-sin-cos-derivative-graph",
  "type": "Figure",
  "number": "2.4.1",
  "title": "",
  "body": " The graph of and the graph of its derivative (which matches ).   "
},
{
  ...
  "number": "2.4.2",
  "title": "",
  "body": "  For all real (measured in radians), and .   "
},
{
  "id": "fig-sin-derivative-triangle",
  "level": "2",
  "url": "sec-derivative-trig.html#fig-sin-derivative-triangle",
  "type": "Figure",
  "number": "2.4.3",
  "title": "",
  "body": " A unit-circle picture motivating via a small angle increment.   "
},
{
  "id": "cor-sin-over-x-limits",
  "level": "2",
  "url": "sec-derivative-trig.html#cor-sin-over-x-limits",
  "type": "Corollary",
  "number": "2.4.4",
  "title": "",
  "body": "  The following limits are immediate consequences of the sine and cosine derivative formulas:        For the first limit, use the derivative of sine at zero:   The second follows similarly from .   "
},
{
  "id": "ex-derivative-tan",
  "level": "2",
  "url": "sec-derivative-trig.html#ex-derivative-tan",
  "type": "Example",
  "number": "2.4.5",
  "title": "",
  "body": "  Compute .    Use and apply the Quotient Rule.    "
},
{
  "id": "tbl-trig-derivatives",
  "level": "2",
  "url": "sec-derivative-trig.html#tbl-trig-derivatives",
  "type": "Table",
  "number": "2.4.6",
  "title": "",
  "body": " Derivatives of the six basic trigonometric functions (angles in radians).                      "
},
{
  ...
  "number": "2.4.7",
  "title": "",
  "body": " These derivative formulas are valid when is measured in radians , not degrees.  "
},
{
...
{
  "id": "exer-trig-derivative-1",
  "level": "2",
  "url": "sec-derivative-trig.html#exer-trig-derivative-1",
  "type": "Checkpoint",
  "number": "2.4.10",
  "title": "",
  "body": "  Differentiate .   "
...
{
  "id": "exer-trig-derivative-2",
  "level": "2",
  "url": "sec-derivative-trig.html#exer-trig-derivative-2",
  "type": "Checkpoint",
  "number": "2.4.11",
  "title": "",
  "body": "  Differentiate .   "
...
{
  "id": "exer-trig-derivative-3",
  "level": "2",
  "url": "sec-derivative-trig.html#exer-trig-derivative-3",
  "type": "Checkpoint",
  "number": "2.4.12",
  "title": "",
  "body": "  Differentiate .   "
...
{
  "id": "exer-trig-limit-1",
  "level": "2",
  "url": "sec-derivative-trig.html#exer-trig-limit-1",
  "type": "Checkpoint",
  "number": "2.4.13",
  "title": "",
  "body": "  Evaluate .   "
...
{
  "id": "exer-trig-limit-2",
  "level": "2",
  "url": "sec-derivative-trig.html#exer-trig-limit-2",
  "type": "Checkpoint",
  "number": "2.4.14",
  "title": "",
  "body": "  Evaluate by rewriting it using a known limit or a derivative interpretation.   "
},
{
