...
},
{
  ...
  "number": "1.4.1",
  "title": "Intermediate Value Theorem.",
  "body": " Intermediate Value Theorem   If is continuous for in the interval , and is between and , meaning either or , then there is at least one (but possibly more) value of Here lies in the open interval , between and but excluding both endpoints: . such that .     Illustration of the Intermediate Value Theorem: a continuous function on , a value between and , and at least one point with .       "
},
{
  "id": "sec-limit-ivt-5",
  "level": "2",
...
{
  "id": "exercises-ivt-2-4",
  "level": "2",
  "url": "sec-limit-ivt.html#exercises-ivt-2-4",
  "type": "Exercise",
  "number": "1.4.2",
  "title": "",
