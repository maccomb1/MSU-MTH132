...
},
{
  ...
  "number": "1.6.5",
  "title": "",
  "body": "  Evaluate the limit     Direct substitution gives an indeterminate form of the type , so we begin by simplifying the numerator.  Combine the fractions in the numerator using a common denominator:   Simplify the numerator:   Substitute this back into the original expression:   Notice that , so we can factor and cancel:   Now we can safely evaluate the limit by substitution:   Therefore,    "
},
{
